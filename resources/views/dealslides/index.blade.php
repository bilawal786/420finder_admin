        ...
        <div class="panel panel-headline">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('dealslides.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        @foreach($slides as $index => $slide)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('dealslides.edit', $slide->id) }}" class="btn" style="margin-top: 1rem">
                                                        Edit
                                                    </a>

                                                    <form action="{{ route('dealslides.destroy', $slide->id) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
