            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('savenewbusiness') }}" method="POST" class="mb-5" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-12 col-12">
                                <div class="form-group pb-3">
                                    ...
                                    <input id="searchTextField" type="text" name="address_line_1" class="form-control">
                                </div>
                              </div>
                              <input type="hidden" id="city2" name="location" />
                              <div class="col-md-6 col-6">
                                  <label for="">Latitude</label>
                                  <input id="cityLat" type="text" name="latitude" class="form-control" readonly="">
                              </div>
                              <div class="col-md-6 col-6">
                                  <label for="">Longitude</label>
                                  <input id="cityLng" type="text" name="longitude" class="form-control" readonly="">
                              </div>
                              <div class="col-md-6 col-6">
                                <div class="form-group pb-3">
