        ...
        <div class="panel panel-headline">
            ...
            <div class="panel-heading">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h3 class="panel-title">Middle Slides</h3>
                    </div>
        ...
        <div class="panel panel-headline">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <form action="{{ route('savemiddleslide') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    @if($slides->count() > 0)
                                        ...
                                        @foreach($slides as $index => $slide)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    {{ $slide->location }}
                                                    <a href="{{ route('deletemiddleslide', ['id' => $slide->id]) }}" onclick="return confirm('Are you sure you want to delete this?');">Delete</a>
                                                </td>
