...
class AddConstraintsToDispensaryProducts extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('dispensery_products', function (Blueprint $table) {
            $table->unsignedBigInteger('dispensery_id')->change();
            ...
            $table->foreign('dispensery_id')->references('id')->on('bussinesses')->onDelete('cascade')->change();
    ...
    {
        Schema::table('dispensery_products', function (Blueprint $table) {
            $table->dropForeign(['dispensery_id']);
